...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="rejecteduser.php?logout='true'"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
    </ul>
  </div>
</nav>
...
<br><br>
<h1 style="text-align:center" class="mt-4">Rejected Users</h1>
                           
<?php
$database= new Database();
@$getallusers = $database->getrejecteduser();
